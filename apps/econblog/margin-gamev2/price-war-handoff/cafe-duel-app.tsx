...
const App = () => (
  <DesignCanvas>
    <DCSection id="entry" title="Entry · before the match" subtitle="Lobby → scenario select → queue → opponent reveal → rematch.">
      ...
      <DCArtboard id="rematch"   label="Rematch · awaiting accept" width={1180} height={920}><Frame><CafeRematch /></Frame></DCArtboard>
    </DCSection>

    <DCSection id="play" title="Play loop" subtitle="Decide → review (2 variants) → locked → slim round report.">
      <DCArtboard id="decide"        label="Decide · inline sliders, no modal" width={1360} height={1280}><Frame><CafeDecide /></Frame></DCArtboard>
      <DCArtboard id="review-modal"  label="Review &amp; lock · modal overlay (A)" width={1180} height={760}><Frame><CafeReviewModal /></Frame></DCArtboard>
      <DCArtboard id="review-inline" label="Review &amp; lock · inline strip (B)" width={1360} height={800}><Frame><CafeReviewInline /></Frame></DCArtboard>
    ...
    <DCSection id="edge" title="Edge states · failure modes &amp; exits" subtitle="Forfeit · Unlock · Austerity (2) · Bankruptcy (2) · Abandonment.">
      ...
      <DCArtboard id="austerity"          label="Austerity · A · banner + grayed cards" width={1360} height={1000}><Frame><CafeAusterity /></Frame></DCArtboard>
      <DCArtboard id="austerity-calm"     label="Austerity · B · calm state-strip only" width={1360} height={1000}><Frame><CafeAusterityCalm /></Frame></DCArtboard>
      <DCArtboard id="bankruptcy"         label="Bankruptcy · A · dramatic" width={1180} height={1000}><Frame><CafeBankruptcy /></Frame></DCArtboard>
      <DCArtboard id="bankruptcy-clinical" label="Bankruptcy · B · chart-first / clinical" width={1280} height={1100}><Frame><CafeBankruptcyClinical /></Frame></DCArtboard>
    ...
    <DCSection id="meta" title="Meta · social &amp; standings" subtitle="Where the rest of the player base shows up.">
      ...
      <DCArtboard id="history"     label="Match history · full log" width={1320} height={920}><Frame><CafeHistory /></Frame></DCArtboard>
