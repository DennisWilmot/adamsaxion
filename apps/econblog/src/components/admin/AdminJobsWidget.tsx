  ...
  return (
    <div className="pointer-events-none fixed bottom-6 right-6 z-50">
      <div className="pointer-events-auto w-[22rem] max-w-[calc(100vw-2rem)]">
        ...
        {open ? (
          <div className="flex max-h-[min(80vh,40rem)] flex-col overflow-hidden rounded-2xl border border-border bg-surface-raised p-lg shadow-2xl">
            ...
            <div className="mt-lg min-h-0 flex-1 overflow-y-auto pr-1">
              <div>
